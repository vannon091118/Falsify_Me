...
export const STATES = Object.freeze(["IDLE","STARTING","LOADING","CLAIMING","THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","SUCCESS","ERROR","TIMEOUT","ABORTING","ABORTED"]);
...
export const ALLOWED = Object.freeze({IDLE:["STARTING","ERROR","TIMEOUT","ABORTING","ABORTED","VERDICT"],STARTING:["LOADING","CLAIMING","THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],LOADING:["CLAIMING","THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],CLAIMING:["LOADING","THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],THINKING:["THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],TOOL_ACTIVITY:["THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],FINDINGS:["THINKING","TOOL_ACTIVITY","FINDINGS","VERIFYING","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],VERIFYING:["THINKING","TOOL_ACTIVITY","FINDINGS","VERDICT","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],VERDICT:["SUCCESS","THINKING","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],SUCCESS:["STARTING","IDLE","ERROR","TIMEOUT","ABORTING","ABORTED"],ERROR:["STARTING","IDLE","ABORTING","ABORTED"],TIMEOUT:["STARTING","IDLE","ERROR","ABORTING","ABORTED"],ABORTING:["ABORTED","ERROR","IDLE"],ABORTED:["STARTING","IDLE"]});
...
const makeSlot=(idx)=>({idx,state:"IDLE",jobId:null,scopeId:null,verdict:null,bootAt:0,lastActivityAt:0,findings:freshFindings(),phases:createPhases(),activity:null,model:null,loopState:null,files:0,filesList:[],events:createRing(80),output:createRing(200),doki:{status:"IDLE",narrator:null,authority:"NONE",contextDigest:null,lines:createRing(80)}});
...
export const createUiState=()=>{const slots=[makeSlot(1),makeSlot(2),makeSlot(3)];return{state:"IDLE",activeSlotIdx:1,slots,jobId:null,scopeId:null,verdict:null,bootAt:0,jobsStarted:0,lastActivityAt:0,findings:slots[0].findings,phases:slots[0].phases,activity:null,model:null,loopState:null,files:0,filesList:[],events:slots[0].events,output:slots[0].output,doki:slots[0].doki,testStatus:null,testSteps:null,testResult:null,stats:null};};

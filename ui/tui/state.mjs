...
export const STATES = Object.freeze([
  ...
  "FINDINGS", "VERDICT", "SUCCESS", "ERROR", "TIMEOUT", "ABORTING", "ABORTED",
]);

// Zustaende, deren Animation "aktive Arbeit" signalisiert.
export const ANIMATED = new Set(["STARTING", "LOADING", "CLAIMING", "THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT"]);
...
export const ALLOWED = Object.freeze({
  ...
  STARTING: ["LOADING", "CLAIMING", "THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],
  LOADING: ["CLAIMING", "THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],
  CLAIMING: ["LOADING", "THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],
  THINKING: ["THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],
  TOOL_ACTIVITY: ["THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],
  FINDINGS: ["THINKING", "TOOL_ACTIVITY", "FINDINGS", "VERDICT", "IDLE", "ERROR", "TIMEOUT", "ABORTING", "ABORTED"],

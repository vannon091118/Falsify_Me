...
export function renderCoderBrief(handoff) {
  ...
  lines.push("write_status (COMPLETED|NO_CHANGE|ABORTED). Die Digests müssen den");
  lines.push("gemessenen Content-Zuständen entsprechen (FalsifyMe misst selbst nach);");

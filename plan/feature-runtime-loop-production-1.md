...
> **Wiederhergestellt am 2026-09-04** aus `d64a07c~1` (die Datei wurde in
> Commit `d64a07c` mit der Docs-Reorg gelöscht, während AGENTS.md/WIRING.md/
> HANDOFF.md sie weiter als Abschluss-Record zitierten). Inhalt = historischer
> Schnappschuss vom **Stand 2026-09-03** — KEIN Live-Dokument. Aktuelle
> Wahrheit für den Produktions-Loop: AGENTS.md „Produktions-Loop (Schema v9)" +
> WIRING §18 (Modul-Karte); die verlinkten Tests existieren weiter (fast/core
> grün, Stand 2026-09-04).
